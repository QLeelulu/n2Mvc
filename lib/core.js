...
//        this.executeFilters('onControllerExecuting', function(result){
//            if(result){
//                result.executeResult(this.ctx.req, this.ctx.res);
//                fnEnd();
//            }else{
//                this.executeFilters('onActionExecuting', function(result){
//                    if(result){
//                        result.executeResult(this.ctx.req, this.ctx.res);
//                        fnEnd();
//                    }else{
...
//            actionResult = this.processActionResult(actionesult);
//            
    ...
    executeWrap: function(i, fnEndRequest){
        ...
        if(filterEventName){
            if(filterEventName === 'executeAction'){
                ...
                this.actionResult.executeResult(this.ctx.req, this.ctx.res);
                i++;
                this.executeWrap(i, fnEndRequest);
            }else{
                
                this.executeFilters(filterEventName, function(actionResult){
                    if(actionResult){
                        actionResult.executeResult(_t.ctx.req, _t.ctx.res);
                        fnEndRequest();
                    }else{
                        i++;
                        _t.executeWrap(i, fnEndRequest);
