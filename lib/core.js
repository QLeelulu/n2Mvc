...
var ControllerFactory = exports.ControllerFactory = Class.extend({
        ...
        if(routeData.controller && routeData.action){
            ...
            try {
                ...
                if(~e.message.indexOf('Cannot find module')){
                    throw new NotFoundError('No controller named "' + routeData.controller + '"');
                }
                ctx.req.error = e;
    ...
    checkAction: function(){
        ...
        if(!this.action){
            this.ctx.req = new NotFoundError('The "' + this.ctx.routeData.controller + '" controller doesn\'t have an action called "' + this.ctx.routeData.action + '"');
            this.ctx.req.canceled = true;
            return false;
        }
